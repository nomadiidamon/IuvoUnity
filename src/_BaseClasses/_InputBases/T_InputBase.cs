    ...
    namespace _Input
    {
        public abstract class InputActionBase : MonoBehaviour, IEnableable
        {
            ...
            protected virtual void Awake()
            {
                ...
                {
                    Debug.LogWarning($"{name}: InputActionReference or its action is not assigned!", this);
                }
            }
        ...
        public class DirectionalInputAction : InputActionBase
        {
            ...
            [SerializeField] private InputActionReference inputUpY;    // e.g., ButtonSouth (hold)
            [SerializeField] private InputActionReference inputDownY;  // e.g., LeftStickButton (tap)
